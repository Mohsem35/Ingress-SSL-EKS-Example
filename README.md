...
Create the Ingress resource for your application with the correct domain (www.shackverse.co) and TLS enabled. Save the following YAML in a file called ingress.yml: 
...
The output should show the domain (www.shackverse.co), the TLS configuration, and the backend service.

**5.3 Test Access:**

Visit https://www.shackverse.co in your browser to verify that SSL is working and that the app is accessible over HTTPS.
